//! `dcode-session` — server-authoritative SessionState control plane (feature
//! 002). Domain layer.
//!
//! ## What this crate is
//! It spawns the claude CLI directly (via 001 `dcode-process`, no ACP/SDK),
...
//! `dcode-conversation` + WebSocket — all Non-Goal here, untouched. This crate
...
//!
//! ## Layering
//! Domain layer, parallel to `dcode-ai-agent`. Depends ONLY on
//! `dcode-process` (001) + `dcode-common`. NO production caller this
