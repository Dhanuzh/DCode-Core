...
//! servers (verified: `crates/dcode-app/tests/live_ws_http_parity_e2e.rs`,
...
mod tests {
    ...
    fn stdio_spec_maps_to_agys_command_shape() {
        ...
        let servers = vec![McpServerSpec {
            name: "dcode-team".into(),
            transport: McpTransport::Stdio {
                command: "/opt/dcode/backend".into(),
        ...
        let s = &read_config(dir.path())["mcpServers"]["dcode-team"];
        assert_eq!(s["command"], "/opt/dcode/backend");
