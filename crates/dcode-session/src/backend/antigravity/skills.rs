...
//! does invoke a skill (verified), and DCode provisions those skills itself
...
/// Where agy looks for workspace skills, and where DCode provisions them.
...
mod tests {
    ...
    fn reads_name_and_description_from_frontmatter() {
        ...
        assert_eq!(cmds[0].name, "dcode-probe");
