...
pub enum SessionEvent {
    ...
    // (No clock/timeout lower: DCode Core does NOT auto-time-out a turn. A user may
    ...
    Detached {
        ...
        /// the 14-keyword allowlist in `dcode_common::error_extract` survive,
    ...
    Permission {
        ...
        /// `{ "server_name": "dcode-team"?, "options": [{"option_id","kind"}] }`.
        ...
        /// AskUserQuestion `{questions:[…]}` — DCode issue #3779: without it the
    ...
    /// the runtime `turn_<shortid>` ids are dcode-minted and mean nothing to
...
mod additive_tests {
    ...
    fn additive_defaults_keep_old_frames_deserializable() {
        ...
        let new_p = r#"{"Permission":{"request_id":"r","kind":"Tool","metadata":{"server_name":"dcode-team"}}}"#;
