use dcode_api_types::{GitHubReleaseAsset, UpdateCheckRequest, UpdateCheckResult, UpdateReleaseInfo};
use serde::Deserialize;

use crate::error::SystemError;

const DEFAULT_REPO: &str = "iOfficeAI/DCode";
...
fn resolve_repo(from_request: Option<&str>) -> String {
    ...
    if let Ok(v) = std::env::var("DCODE_GITHUB_REPO")
        && !v.is_empty()
    {
        return v;
    }
