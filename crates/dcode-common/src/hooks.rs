...
//!
//! Hooks defined here let lower-layer crates (e.g. `dcode-ai-agent`,
//! `dcode-cron`) react to events owned by higher-layer crates (e.g.
//! `dcode-conversation`) without forming a dependency cycle.
