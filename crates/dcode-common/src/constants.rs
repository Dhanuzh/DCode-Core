...
pub const DCODE_TIMESTAMP_SEPARATOR: &str = "_dcode_";
pub const DCODE_FILES_MARKER: &str = "[[DCODE_FILES]]";
...
pub const COOKIE_NAME: &str = "dcode-session";
pub const COOKIE_MAX_AGE_DAYS: u32 = 30;
pub const CSRF_COOKIE_NAME: &str = "dcode-csrf-token";
