...
use dcode_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_dcode_aliases() {
    ...
    #[test]
    fn teammate_status_serde_dcode_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_dcode_format() {
