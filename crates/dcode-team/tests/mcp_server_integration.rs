...
use dcode_team::{Mailbox, TaskBoard, TeamAgent, TeamMcpServer, TeamPromptDumpConfig, TeammateManager, TeammateRole};
...
async fn sb1_bridge_config_generation() {
    use dcode_team::{TeamMcpStdioConfig, TeamMcpStdioServerSpec};
