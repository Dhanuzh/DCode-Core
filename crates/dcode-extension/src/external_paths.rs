...
///
/// Data is stored in `~/.dcode/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the dcode skills market by adding it to external paths.
    ...
    /// Disable the dcode skills market by removing it from external paths.
