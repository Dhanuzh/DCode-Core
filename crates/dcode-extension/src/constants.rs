...
/// Well-known skill source name for the dcode skills market.
pub const SKILLS_MARKET_NAME: &str = "dcode-skills";

/// Well-known skill source path for the dcode skills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/DCode/dcode-skills";
