...
const EXTENSION_STATES_FILE_ENV: &str = "DCODE_EXTENSION_STATES_FILE";
...
/// Resolve the extension state file path using the historical DCode rules.
///
/// Priority:
/// 1. `DCODE_EXTENSION_STATES_FILE`
