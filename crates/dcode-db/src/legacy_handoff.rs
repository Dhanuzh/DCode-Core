...
mod tests {
    ...
    fn migration_002_direct_legacy_reads_are_audited() {
        ...
        let documented_non_contract_reads = [
            ("messages", "hidden", "DCode v22 adds it before v23-v26 issue path"),
            (
                "conversations",
                "source",
                "DCode v8 baseline before v23-v26 issue path",
            ),
            (
                "conversations",
                "channel_chat_id",
                "DCode v14 baseline before v23-v26 issue path",
            ),
            ("mailbox", "files", "DCode v25 adds it on the observed v23->v26 path"),
            (
                "remote_agents",
                "allow_insecure",
                "DCode v18 baseline before v23-v26 issue path",
            ),
            (
                "cron_jobs",
                "execution_mode",
                "DCode v22 baseline before v23-v26 issue path",
            ),
            (
                "cron_jobs",
                "agent_config",
