...
/// model_health, model_settings, bedrock_config, vertex_config) are stored as
/// TEXT in SQLite and deserialized by the service layer.
...
pub struct Provider {
    ...
    /// JSON object: Vertex AI-specific configuration (project, location, auth).
