...
struct AgentMetadataSafeRow {
    ...
    last_check_at: Option<dcode_common::TimestampMs>,
    last_success_at: Option<dcode_common::TimestampMs>,
    last_failure_at: Option<dcode_common::TimestampMs>,
    command_override: Option<String>,
    env_override: Option<String>,
    created_at: dcode_common::TimestampMs,
    updated_at: dcode_common::TimestampMs,
}
...
mod tests {
    ...
    async fn seed_rows_populated_after_migrations() {
        ...
        assert!(
            rows.iter()
                .any(|r| r.name == "DCode CLI" && r.agent_source == "internal")
        );
