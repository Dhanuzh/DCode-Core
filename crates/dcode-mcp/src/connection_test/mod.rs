...
fn map_phase(phase: dcode_runtime::NodeRuntimeProgressPhase) -> RuntimeStatusPhase {
    match phase {
        dcode_runtime::NodeRuntimeProgressPhase::WaitingForLock => RuntimeStatusPhase::WaitingForLock,
        dcode_runtime::NodeRuntimeProgressPhase::Downloading => RuntimeStatusPhase::Downloading,
        dcode_runtime::NodeRuntimeProgressPhase::Extracting => RuntimeStatusPhase::Extracting,
        dcode_runtime::NodeRuntimeProgressPhase::Validating => RuntimeStatusPhase::Validating,
        dcode_runtime::NodeRuntimeProgressPhase::Ready => RuntimeStatusPhase::Ready,
        dcode_runtime::NodeRuntimeProgressPhase::Failed => RuntimeStatusPhase::Failed,
    }
}
...
mod tests {
    ...
    use dcode_realtime::EventBroadcaster;
    use dcode_runtime::{NodeRuntimeProgress, NodeRuntimeProgressPhase};
    use std::io::Write;
    use std::sync::Mutex;
    use tracing::Level;
