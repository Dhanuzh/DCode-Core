...
use dcode_api_types::{DetectedMcpServerEntry, DetectedMcpServerResponse};
...
fn detected_to_response(detected: DetectedServer) -> DetectedMcpServerEntry {
    ...
    DetectedMcpServerEntry {
        server: dcode_api_types::McpServerResponse {
            ...
            tools: None,
            last_test_status: dcode_common::McpServerStatus::Disconnected,
            last_connected: None,
            original_json: None,
            builtin: false,
            created_at: 0,
