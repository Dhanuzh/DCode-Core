...
//!
//! Lives in its own subdir `{data_dir}/runtime/dcode-process/registry.json`,
...
pub const SUBDIR: &str = "runtime/dcode-process";
...
/// File-backed registry under `{data_dir}/runtime/dcode-process/registry.json`.
