...
use dcode_db::{IAcpSessionRepository, SaveRuntimeStateParams};
...
impl AcpSessionSyncService {
    ...
    pub async fn load_persisted(
        ...
        user_id: &str,
        conversation_id: &str,
    ) -> Option<dcode_db::PersistedSessionState> {
...
mod tests {
    ...
    use dcode_db::{CreateAcpSessionParams, SqliteAcpSessionRepository, init_database_memory};
