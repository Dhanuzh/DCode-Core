...
use dcode_db::{IMcpServerRepository, IProviderRepository};
...
pub struct AgentFactoryDeps {
    ...
    pub session_spawner: Arc<dyn dcode_process::Spawner>,
    ...
    /// mode, so DCode registers its own binary as a PreToolUse hook and
