...
const ACP_CLIENT_NAME: &str = "DCode";
...
/// Log a JSON-RPC request from DCode to the ACP agent.
...
/// Log a fire-and-forget notification from DCode to the agent.
...
/// Log a JSON-RPC response from DCode back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "DCode");
        ...
        assert_eq!(json["clientInfo"]["name"], "DCode");
