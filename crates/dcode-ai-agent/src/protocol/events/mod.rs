...
pub use dcode_api_types::AgentStreamErrorData as ErrorEventData;
...
///
/// `phase` reuses the session layer's [`dcode_session::MessageLifecyclePhase`]
...
/// without taking their own `dcode-session` dependency.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub use dcode_session::MessageLifecyclePhase;
