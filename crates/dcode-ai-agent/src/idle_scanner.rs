...
use dcode_common::{AgentKillReason, now_ms};
...
const ENV_SOLO_IDLE_TIMEOUT_SECS: &str = "DCODE_IDLE_TIMEOUT_SECS";
/// Environment variable overriding the team idle timeout, in seconds.
const ENV_TEAM_IDLE_TIMEOUT_SECS: &str = "DCODE_TEAM_IDLE_TIMEOUT_SECS";
/// Environment variable overriding the idle scan interval, in seconds.
const ENV_IDLE_SCAN_INTERVAL_SECS: &str = "DCODE_IDLE_SCAN_INTERVAL_SECS";
...
mod tests {
    ...
    use dcode_common::AgentKillReason;
    use async_trait::async_trait;
