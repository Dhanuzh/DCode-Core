...
mod weixin_tests {
    ...
    use dcode_channel::manager::{ChannelManager, PluginFactory};
    use dcode_channel::plugin::ChannelPlugin;
    use dcode_channel::plugins::weixin::WeixinPlugin;
    use dcode_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use dcode_channel::plugins::weixin::weixin_login_stream;
