...
use dcode_channel::stream_relay::{ChannelStreamRelay, MessageRecorder, RelayConfig, throttle_ms_for_platform};
...
async fn weixin_flushes_pending_text_before_tool_call() {
    // Port of DCode TS fix `406a62665` to the backend relay layer. On
