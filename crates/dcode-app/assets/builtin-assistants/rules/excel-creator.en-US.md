...
> After the spreadsheet file appears in the workspace, you can preview it directly in DCode. However, please do not click "Open with system app", as this may lock the file and cause generation to fail.
