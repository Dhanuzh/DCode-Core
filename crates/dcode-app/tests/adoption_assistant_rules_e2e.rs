//! End-to-end reproduction of the DCode → AionPro adoption path for
...
use dcode_assistant::service::AssistantServiceDeps;
use dcode_assistant::{AssistantService, BuiltinAssistantRegistry};
use dcode_db::{
...
use dcode_extension::{SkillPaths, fs_adopt};
...
/// dcode-auth does: provision external user → DB adoption (stamps the
