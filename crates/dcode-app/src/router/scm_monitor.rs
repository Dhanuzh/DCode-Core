...
//!
//! Adapts the transport-agnostic [`ScmActor`] (in `dcode-project`) to the
...
use dcode_project::scm::{ScmActor, ScmInbound, ScmWirePush};
use dcode_realtime::{ConnectionId, MessageRouter, WebSocketManager};
