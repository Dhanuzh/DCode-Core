//! Agent-readable capability contract for `dcode-core config`.

use serde_json::{Value, json};

const RUNTIME_ENV: [&str; 3] = ["DCODE_BASE_URL", "DCODE_CONVERSATION_ID", "DCODE_USER_ID"];
...
pub(crate) fn data() -> Value {
    json!({
        ...
        "input": {
            ...
            "selectors": {
                "assistant_id": {
                    "current": "resolve via DCODE_CONVERSATION_ID",
                ...
                "user_id": {
                    ...
                    "literal": "ignored and replaced with DCODE_USER_ID"
                }
            }
        },
        "output": {
