//! Agent-readable capability contract for `dcode-core diagnose`.
...
pub(crate) fn data() -> Value {
    json!({
        ...
        "runtime_context": {
            ...
            "optional_environment": ["DCODE_LOG_DIR"]
        },
        "safety": {
            "read_only": true,
            "redacted_by_default": [
        ...
        "domains": [
            ...
            domain("logs", &[
                command(CommandDescriptor {
                    path: &["logs", "tail"],
                    description: "Tail dcode-core logs from DCODE_LOG_DIR or stdin log_dir.",
                    input: "stdin_json",
